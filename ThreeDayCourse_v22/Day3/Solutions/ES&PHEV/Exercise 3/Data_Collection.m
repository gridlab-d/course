...
clc
format long g
read_dir=['C:\PNNL Work\Current Projects\AEP-Demo\Training Course\Battery 3\'];
...
file=['Battery1.csv'];
read_file = [read_dir,file];
Battery1=csvread(read_file,9,1,[9,1,10009,2]);

file=['Battery2.csv'];
read_file = [read_dir,file];
Battery2=csvread(read_file,9,1,[9,1,10009,2]);

file=['Battery1_Meter.csv'];
read_file = [read_dir,file];
Battery1_Meter=csvread(read_file,9,1,[9,1,10009,2]);

file=['Battery2_Meter.csv'];
read_file = [read_dir,file];
Battery2_Meter=csvread(read_file,9,1,[9,1,10009,2]);
